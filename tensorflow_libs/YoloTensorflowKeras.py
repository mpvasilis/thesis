...
def yolo_object_detection(image_path):
    ...
    weightsyolov3 = 'C:\\Users\\Vasilis\\Desktop\\ThesisMaterial\\YOLOv3\\cfg\\yolov3.weights'  # path to weights file
    ...
    """Εισαγώγή των εκπαιδευμένων βαρών απο το Darknet"""
    ...
    """ Σχεδίαση κουτιού οριοθέτησης, όνομα κλάσης και πιθανότητα"""
    ...
    """Δημιουργήστε προσαρμοσμένα επίπεδα και μοντέλο"""
    ...
    name = 'test2.jpg'  # path to test image
    ...
    cv2.imwrite('Cappuccino-6659sak.jpg', img)
